...
- [README](../README.md): 機能、利用方法、URLパラメーター
- [RedirectPageからの移行ガイド](./MIGRATION.md): 旧URLと外部呼び出し元の更新方法
...
- [既存仕様・外部動作の変更](./spec_changes.md): 既存の外部動作に影響する変更記録
- [不具合修正](./bug_fixes.md): 不具合と修正内容の記録
- [内部構造の改善](./refactoring.md): 外部動作を変えない内部改善の記録
